    ...
    layui.use(['table','form','element'],function () {
        ...
        table.on('toolbar(test)', function(obj){
            ...
            switch(obj.event){
                case 'add':
                    layer.msg('添加');
                    window.location.href="${pageContext.request.contextPath}/jsp/permission/addpermission";
                    break;
                case 'update':
                    if(data.length === 0){
                        layer.msg('请选择一行');
        ...
        form.on('switch(active)', function (obj) {
            ...
            layer.open({
                ...
                yes:function (index) {//第一个按钮触发的事件
                    ...
                    //发送ajax请求 改变状态
                    $.ajax({
                        url:'${pageContext.request.contextPath}/permission/active',
                        data:{"perId":id,"status":status},
                        dataType:'json',
                        type:'post',
                        cache:false,
            ...
            layer.open({
                ...
                yes: function (index, layero) {
                    ...
                    $.ajax({
                        ...
                        //表单序列化 perId=2&userAccount=rose&rids=1&rids=2&rids=3&rids=4
                        data: $("#fm1").serialize(),
                        success: function (obj) {
                            if (obj) {
    ...
    <form id="fm1" class="layui-form layui-form-pane" >
        <div class="layui-form-item" pane >
            ...
            <div class="layui-input-inline">
                <input type="hidden" id="perId" name="perId" readonly class="layui-input">
