		...
		<div class="layui-header">
			...
			<ul class="layui-nav layui-layout-right">
				<li class="layui-nav-item">
					...
					<dl class="layui-nav-child">
					<dd class="lef_menu" url="${pageContext.request.contextPath}/jsp/user/headimage"  pid="8"><a href="#">修改头像</a></dd>
			...
			<div class="layui-side-scroll">
				...
				<ul class="layui-nav layui-nav-tree"  lay-filter="test">
					<li class="layui-nav-item layui-nav-itemed">
						...
						<dl class="layui-nav-child">
							<dd class="lef_menu" pid="6" url="${pageContext.request.contextPath}/jsp/user/userlist"><a  href="javascript:;">用户列表</a></dd>
						</dl>
					</li>
					<li class="layui-nav-item">
						<a href="javascript:;">角色管理</a>
						<dl class="layui-nav-child">
							<dd class="lef_menu" url="${pageContext.request.contextPath}/jsp/role/rolelist" pid="5"><a href="javascript:;">角色列表</a></dd>
					...
					<li class="layui-nav-item">
						...
						<dl class="layui-nav-child">
							<dd class="lef_menu" url="${pageContext.request.contextPath}/jsp/permission/permissionlist" pid="4"><a href="javascript:;">权限列表</a></dd>
					...
					<li class="layui-nav-item">
						...
						<dl class="layui-nav-child">
							<dd class="lef_menu" pid="3" url="${pageContext.request.contextPath}/jsp/product/productlist"> <a href="javascript:;">商品列表</a></dd>
